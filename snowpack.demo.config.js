...
module.exports = {
  ...
  alias: {
    ...
    '@qbcart/eshop-alert-hooks': 'https://qbcdemo.z13.web.core.windows.net/eshop/alert-hooks/index.js',
    'alert-modal': 'https://qbcdemo.z13.web.core.windows.net/eshop/alert-modal/index.js'
  }
};
